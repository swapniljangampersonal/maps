package com.blueetios.angularmaps.config;
...
@Configuration
@EnableMongoRepositories("com.blueetios.angularmaps.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.blueetios.angularmaps.config.dbmigrations");
